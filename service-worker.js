const CACHE='ascend-discipline-v21-pwa-logo';
const ASSETS=['./','./index.html','./css/style.css','./js/storage.js','./js/app.js','./manifest.webmanifest','./assets/icon-192.png?v=20260803','./assets/icon-512.png?v=20260803'];
